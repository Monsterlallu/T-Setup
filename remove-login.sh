...
tput cup 6 30
echo -e "\x1b[42m MONSTER_LALLU by MONSTER \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have you subscribe my channel MONSTER_LALLU by MONSTER (y/n)? \e[m "
read answer
...
tput cup 20 0
figlet -f slant "MONSTER_LALLU by MONSTER" |lolcat
echo " "
echo " "
